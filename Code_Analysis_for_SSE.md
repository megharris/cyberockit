...
We collaborated well by asking each other for assistance in determining the controls that should be in place as well as identifying them in the code. We all agree that we would be happy to work togehter again in the future if some of our members were not graduating this semeseter.
